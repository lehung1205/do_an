...
public class AdminPaymentRevenueDto
{
    ...
    public IReadOnlyList<AdminChartPointDto> MonthlyRevenue { get; set; } = Array.Empty<AdminChartPointDto>();
    public IReadOnlyList<AdminPaymentStatusCountDto> ByStatus { get; set; } = Array.Empty<AdminPaymentStatusCountDto>();
}
