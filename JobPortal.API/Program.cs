...
using JobPortal.API.Repositories.Implementation;
...
builder.Services.AddScoped<IPostingPackageRepository, PostingPackageRepository>();
...
builder.Services.AddScoped<IAdminPostingPackageService, AdminPostingPackageService>();
...
builder.Services.AddCors(options =>
{
    ...
    {
        policy.WithOrigins("http://localhost:5074", "https://localhost:7060")
            .AllowAnyHeader()
            .AllowAnyMethod()
            .AllowCredentials();
    });
